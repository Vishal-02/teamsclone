...
pusher_client = Pusher(app_id='1231015',
                       key='6d23b310256611494091',
                       secret='d6fcb6919ff65fa19314',
                       ssl=True,
                       cluster='ap2')
...
def index(request):
    ...
    # print("___________________________________LOOK HERE FOR WHAT YOU PRINTED____________________________________")
    # print(f"{app_id}, {key}, {secret}, {cluster}")
    User = get_user_model()
